defmodule PcoApi.People.Person.FieldDatumTest do
  ...
  def field_datum do
    field_definition = "https://api.planningcenteronline.com/people/v2/people/1/field_data/2/field_definition"
    field_option = "https://api.planningcenteronline.com/people/v2/people/1/field_data/2/field_option"
  ...
  defp new_record, do: %PcoApi.Record{attributes: %{"value" => "Grilled Cheese"}, type: "FieldDatum"}
end
