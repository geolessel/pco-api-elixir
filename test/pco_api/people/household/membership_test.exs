defmodule PcoApi.People.Household.MembershipTest do
  ...
  def membership do
    %PcoApi.Record{
      ...
      links: %{
        "household" =>
          "https://api.planningcenteronline.com/people/v2/households/1/household_memberships/2/household",
        "person" =>
          "https://api.planningcenteronline.com/people/v2/households/1/household_memberships/2/person"
      }
    }
  end
end
